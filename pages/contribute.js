                ...
                <Card id="contribute-1-1">
                  ...
                  <Accordion.Collapse eventKey="#contribute-1-1">
                    <div className="card-body">
                      ...
                      <p>
                        {t(
                          '4. <a href="https://docs.idena.io/docs/community/affiliate">Apply for a referral link</a>, share it with your community, and get rewards for successful invitations.',
                          {ns: 'contribute'}
                        )}
                      </p>
                    </div>
