          ...
          <div className="row justify-content-center">
            <div className="col-md-7 col-lg-6">
              <div className="section_header">
                <h3 className="h1">{t('What is a flip')}</h3>
              </div>
              <p>
                {t(
              ...
              <p>
                ...
                <a
                  ...
                  rel="nofollow"
                >
                  {t('AI-resitant captchas')}
                </a>{' '}
                {t('in Idena blog')}.
              </p>

              <h3>{t('Why machines have no common sense')}</h3>
          ...
          <div className="row justify-content-center">
            <div className="col-md-7 col-lg-6">
              <p>
                ...
                {t('to check whether you are bot or not.')}
              </p>

              <h3>{t('Flip challenge')}</h3>

              <p>
                <Trans i18nKey="aiResearchRewardNotice" t={t}>
                ...
                <div className="tab-pane show active" role="tabpanel">
                  <div className="table-responsive">
                    <table className="table">
                      <tr>
                        <th>
                          <Trans i18nKey="minimumAccuracy" t={t}>
                            Minimum
                            <br />
                            accuracy
                          </Trans>
                        ...
                        <th>Prize</th>
                        <th>
                          <Trans i18nKey="cascadePrize" t={t}>
                            Cascade
                            <br />
                            prize
                          </Trans>
              ...
              <p>
                {t(
                  'AI should be trained on the dataset of flips that currently available in the'
                )}{' '}
                <a href="https://scan.idena.io">{t('blockchain explorer')}</a>.{' '}
                {t(
                  `Idena team will use the limited number of invites to collect out of sample flips for contestants' AI testing.`
                )}
              </p>

              <b>{t('Flip challenge committee:')}</b>
              <p>
                {t(
